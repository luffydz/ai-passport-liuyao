...
extern const lv_font_t lv_font_kai_48;    // 欢迎页大标题（楷书，仅「六爻」）
extern const lv_font_t lv_font_kai_34;    // 卦名 / 输入格数字（楷书）
extern const lv_font_t lv_font_sans_18;   // 正文（黑体，含全部卦理数据用字）
