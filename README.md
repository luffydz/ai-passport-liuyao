...
| 卦 辞 | 卦辞原文，配一句白话 |
| 变 卦 | 动爻变出的卦 |
| 断 卦 | 动爻；爻辞原文 + 白话；本卦与其白话、变卦与其白话；再四段断语（力量 · 虚实 · 双方 · 建议）|
...
- **断卦页的排版**：按「一条原文／紧跟它自己的白话」成对排 —— 爻辞原文→白话；本卦→其白话（爻位，说现状）、变卦→其白话（五行走向，说趋势）。最后四段断语：力量（旺衰 × 日辰，25 种）· 虚实（用神是否逢空，2 种）· 双方（世应生克，5 种）· 建议（8 事由 × 5 档旺衰，40 种）。
